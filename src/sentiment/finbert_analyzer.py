...
class FinBERTAnalyzer:
    ...
    def analyze_batch(self, df: pd.DataFrame, text_col: str = None,
        ...
        Args:
            ...
            text_col: Name of the text column (auto-detected if None)
        ...
        print(f"\n  FinBERT: Analyzing {len(df)} headlines (using column: {text_col})...")
